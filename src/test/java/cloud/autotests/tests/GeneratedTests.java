...
public class GeneratedTests extends TestBase {
    ...
    void searchValidationOfferTest() {
        ...
        step("Открываем сайт 'https://stage.onlc.market/'", () -> {
            open("https://stage.onlc.market/");
        });

        step("Вводим в поиске значение и нажимаем Enter", () -> {
            $("#HomeOffersForm_query").setValue("Клавиатура DX1").pressEnter();
        });

        step("Проверяем отображение", () -> {
            $(".card___StyledCol4-sc-1ka6810-7").shouldHave(text("Клавиатура DX1"));
        });
    ...
    void searchValidationInnTest() {
        ...
        step("Вводим в поиске значение и нажимаем Enter", () -> {
            $("#HomeOffersForm_providerQuery").setValue("5985464882").pressEnter();
        });

        step("Проверяем отображение", () -> {
            $(".card___StyledCol5-sc-1ka6810-10").shouldHave(text("ПАО \"Полемика и Ъ\""));
        });

        step("Проверяем отображение страницы поиска", () -> {
            $(".sub-top___StyledCol-sc-es4zgy-1").shouldBe(visible).shouldHave(text("Найдено: 4"));
        });
    }
